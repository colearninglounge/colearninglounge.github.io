...
import RecentEventsCollection from "./recentEvents/RecentEventsCollection";

const RecentEvents = ({ spacing, color, btn }) => {
  ...
  return (
    <div
      className={`${spacing ? spacing : "mt-24 py-24"} ${
        color
          ? color
          : "text-white bg-gradient-to-tr from-heroGradLeft to-heroGradRight"
      } text-center`}
    >
      <div className="container px-6 md:px-0 xl:px-12 mx-auto">
        <h2 className="font-bold text-3xl md:text-5xl">Recent Events</h2>
        <h3 className="font-normal mt-3">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </h3>
      </div>
      <div className="relative">
        <RecentEventsCollection scrollRef={collection} />
        <button
      ...
      <div className="flex justify-center">
        {btn ? (
          ...
          <BaseButton
            ...
            classes="bg-white text-primary mt-8"
          />
        )}
      </div>
    </div>
